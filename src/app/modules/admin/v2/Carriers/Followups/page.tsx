...
const FollowUp = () => {
  ...
  const handleAddFollowUpClick = () => {
    router.push('/modules/admin/v2/Carriers/Followups/Addfollowup');
  };
  ...
  const renderTabContent = () => {
    ...
    const filteredFollowUps = followUpData.filter(item => item.followupMethod === activeTab && item.followupCategory === 'Carriers');
          ...
          {filteredFollowUps.map((followUp) => {
            ...
            return (
              <tr
                ...
                onClick={() => router.push(`/modules/admin/v2/Carriers/FollowUps/${followUp.id}`)} // Navigate to details page
              >
                ...
                <td className="border px-4 py-2">
                  <a
                    onClick={(e) => {
                      ...
                      router.push(`/modules/admin/v2/Carriers/FollowUps/${followUp._id}`); // Link to customer details
                    }}
