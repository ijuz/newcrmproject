...
const Toast = ({ message, type, onClose }) => {
  ...
  return (
    <div className={`flex items-center gap-2 px-4 py-3 rounded-lg shadow-lg ${type === 'success' ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-red-100 text-red-800 border border-red-200'}`}>
...
const EmailDashboard = () => {
  ...
  const [formData, setFormData] = useState({
    sender: '"cloudqlobe",marketing@cloudqlobe.com',
    recipient: '',
    subject: '',
    body: '',
  });
