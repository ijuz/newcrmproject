...
const FollowUp = () => {
  ...
  const handleAddFollowUpClick = () => {
    router.push('/modules/admin/v2/Sales/Followups/Addfollowup');
  };
          ...
          {filteredFollowUps.map((followUp) => {
            ...
            return (
              <tr
                ...
                onClick={() => router.push(`/modules/admin/v2/Sales/FollowUps/${followUp.id}`)} // Navigate to details page
              >
                ...
                <td className="border px-4 py-2">
                  <a
                    onClick={(e) => {
                      ...
                      router.push(`/modules/admin/v2/Sales/FollowUps/${followUp._id}`); // Link to customer details
                    }}
