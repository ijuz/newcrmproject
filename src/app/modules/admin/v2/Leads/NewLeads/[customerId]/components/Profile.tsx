            ...
            <div className="flex justify-end">
              ...
              >
                ...
                <div className="flex space-x-4">
                  <button onClick={() => handleConversion("CustomerLead")} className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors">
                    Convert to Customer Lead
                  </button>
                  <button onClick={() => handleConversion("CarrierLead")} className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors">
                    Convert to Carrier Lead
                  </button>
                </div>
              </div>
              <div>
