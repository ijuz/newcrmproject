...
const EmailTab = ({ sampleData }) => {
  ...
  const handleRowClick = (customerId) => {
    // Navigate to the detail page with the customer ID (replace with your actual navigation logic)
    window.location.href = `/modules/admin/Support/FollowUp/detail?customerId=${customerId}`;
  };
