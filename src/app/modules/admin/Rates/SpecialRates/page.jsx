...
const SpecialRatesPage = () => {
  ...
  const [specialRatesData, setSpecialRatesData] = useState([
    { countryCode: 'US', countryName: 'United States', qualityDescription: 'Premium', rate: 150, status: 'Active', profile: 'Profile A', testControl: true, testStatus: 'Passed' },
    { countryCode: 'CA', countryName: 'Canada', qualityDescription: 'Standard', rate: 100, status: 'Inactive', profile: 'Profile B', testControl: false, testStatus: 'Failed' },
    // Add more rows as needed
  ]);

  const filteredData = specialRatesData.filter(item =>
  ...
  const handleAddRate = () => {
    setSpecialRatesData([...specialRatesData, newRate]);
    setNewRate({
      countryCode: '',
      countryName: '',
      qualityDescription: '',
  ...
  return (
    <div className="p-6 bg-gray-100 text-gray-800 min-h-screen">
      <h2 className="text-xl font-bold text-blue-600">Special Rates</h2>
      <p className="text-gray-500 mt-2">Manage your special rates here.</p>
      ...
      {/* Dialog Box for Adding Special Rate */}
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-lg p-6 w-96 shadow-lg">
            <h3 className="text-lg font-bold mb-4 text-blue-600">Add Special Rate</h3>
            <div className="mb-4">
